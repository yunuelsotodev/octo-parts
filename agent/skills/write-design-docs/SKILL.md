...
description: Write, revise, or review software design documents using Malte
  Ubl's "Design Docs at Google" guidance. Use when Codex needs to draft a design
  doc, technical design, RFC, engineering review doc, architecture proposal,
  mini design doc, or design-doc review focused on context, goals, non-goals,
  trade-offs, alternatives, cross-cutting concerns, review lifecycle, and
  deciding whether a design doc is warranted.
---
# Write Design Docs
